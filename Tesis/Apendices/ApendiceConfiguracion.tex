...
El "mtry" que indica la cantidad máxima de variables en cada árbol se configuró en 12. El mismo se calculó como el piso de la raíz cuadrada de la cantidad de neuronas. Se aconseja calcular el "mtry" de esta forma por primera vez, y luego si fuera necesario ir variando el valor hasta obtener la mejor performance. \\\\
Los comandos MatLab para ejecutarlo son:\\
