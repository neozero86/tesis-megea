...
{\Gls{PDC} de las neuronas VTA - Corridas individuales. Cada par X-Y corresponde a una neurona con su \glssymbol{PDC} (media para las 500 corridas). - LDA}

\figura{Bitmap/11/PFC_individual}{width=1\textwidth}{capSetDeDatos:fig:PFCIndividual}%
{\Gls{PDC} de las neuronas PFC - Corridas individuales. Cada par X-Y corresponde a una neurona con su \glssymbol{PDC} (media para las 500 corridas). - LDA}
