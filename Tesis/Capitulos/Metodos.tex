...
El método \textit{Support Vector Machine} (SVM) se basa en la idea de proyectar los datos en un espacio dimensional mayor, con el fin de encontrar un \gls{H} que permita separar las clases. Las características del \gls{H} aseguran una alta capacidad de generalización de este método de aprendizaje automático \citep{cortes1995support}.
\\
