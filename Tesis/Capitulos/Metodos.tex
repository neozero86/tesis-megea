...
Este método fue utilizado para clasificación de \textit{\glspl{S}} en forma semiautomática en \citet{harris2000accuracy} con buenos resultados, superando la clasificación manual. A su vez, en \citet{hu2005feature} se lo utilizó para predecir la decisión de una rata clasificando los \textit{\glspl{S}} de las neuronas del \gls{ACM}. En esa ocasión se lo combinó con un \gls{PCA} para extraer las mejores \glspl{F} y de esta manera competir con la performance obtenida con \glspl{C} mas robustos.\\ Al igual que con el \Gls{C} Lineal de Fisher, este método es ampliamente utilizado debido a su velocidad de entrenamiento y clasificación.\\ Se pueden encontrar mas ejemplos de su aplicación en procesamiento de señales neuronales en \citet{schmuker2014neuromorphic, valenti2006automatic}
