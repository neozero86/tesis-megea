...
\typeout{Copyright Matías Leonel Egea}
...
\ifpdf\hypersetup{%
    pdftitle = {\titulo},
    pdfsubject = {Tesis de grado en Ingeniería en Informática de Matías Leonel Egea},
    pdfkeywords = { tesis, trabajo de investigación, spikes, Random Forest, Bayes Naive, Discriminante Linear de Fisher, SVM, potenciales de acción neuronal, Área Ventral Tegmental, Corteza Pre-Frontal, VTA, PFC, Support Vector Machine, Matías Egea},
...
\fancyhead[LO]{\nouppercase{Glosario de términos}}
\fancyhead[RO]{\nouppercase{Glosario de términos}}
