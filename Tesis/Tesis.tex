...
\ifpdf\hypersetup{%
    pdftitle = {\titulo},
    pdfsubject = {Tesis Matías Leonel Egea},
    pdfkeywords = { tesis, trabajo de investigación, spikes, Random Forest, Bayes Naive, Discriminante Linear de Fisher, SVM, potenciales de acción neuronal, Área Ventral Tegmental, Corteza Pre-Frontal },
...
\printglossary[title={Glosario de palabras}]
%
% Índice de palabras
%
